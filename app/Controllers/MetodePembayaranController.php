...
class MetodePembayaranController extends BaseController
{
    ...
    function __construct()
    {
        ...
        $this->endpoint = base_url('admin/metode-pembayaran');
    }

    public function index()
    {
        $data['title'] = 'Metode Pembayaran';
        $data['content'] = 'metode-pembayaran/index';

        $data['metode_pembayaran'] = $this->model->paginate(5);
    ...
    {
        $data['title'] = 'Create Metode Pembayaran';
        $data['content'] = 'metode-pembayaran/create';
    ...
    public function edit()
    {
        ...
        $data['content'] = 'metode-pembayaran/edit';
        if(!$data['metode'] = $this->model->where(['id'=>$this->request->getGet('id')])->first()){
            return ;
        }
        return view('layout/index',$data);
    }
