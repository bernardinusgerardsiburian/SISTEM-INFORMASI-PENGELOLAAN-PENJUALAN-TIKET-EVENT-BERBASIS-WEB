            ...
            <div class="table-responsive">
                <table class="table table-centered table-nowrap mb-0 rounded">
                    ...
                    <tr>
                        ...
                        <th class="border-0">Waktu Pembelian</th>
                        <th class="border-0">Total Tiket</th>
                        <th class="border-0">Total Pembelian</th>
                    ...
                    <?php foreach($transaksi as $row):?>
                        <tr>
                            ...
                            <td><a href="<?= base_url('admin/laporan/tiket-event-cetak').'?kode='.$row['kode']?>" class="btn btn-sm btn-outline-success mb-2">Cetak</a>
                        </tr>
                    <?php endforeach?>
                    </tbody>
                </table>
