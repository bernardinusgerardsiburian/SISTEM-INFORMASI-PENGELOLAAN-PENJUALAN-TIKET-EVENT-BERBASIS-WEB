...
<?php }else{?>
    <div class="card border-0 shadow mb-4">
        <div class="card-body">
            <a href="<?= base_url('admin/laporan/kategori-cetak').'?daritanggal='.$daritanggal.'&sampaitanggal='.$sampaitanggal?>" class="btn btn-outline-success mb-2">Cetak</a>
            <div class="table-responsive">
                <table class="table table-centered table-nowrap mb-0 rounded">
                    <thead class="thead-light">
                    <tr>
                        <th class="border-0">Kategori Event</th>
                        <th class="border-0">Jumlah Event</th>
                        <th class="border-0">Jumlah Tiket Terjual</th>
                        <th class="border-0">Jumlah Pendapatan</th>
                    </tr>
                    </thead>
                    <tbody>
